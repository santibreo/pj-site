---
title: "VAR EAR EVE and NII"
author: "Santiago Breogán Pérez Pita - <`r paste0(Sys.getenv('USERNAME'), '@gruposantander.com')`>"
...
This document is all about the main metrics used by ALM teams. They are pretty
common when measuring the potential risk that a company faces, mandatory if
the company operates internationally, because these metrics capture the 
sensitivity of the company operations to interest rates risks.
