...
Just a summit of [this latex tutorial](https://riptutorial.com/es/latex), with the main ideas I do not want to forget.
...
**Latex** is well suited to make presentations but I won't cover how here. If you want to use it for this purpose you can follow [this tutorial](https://www.overleaf.com/learn/latex/Beamer).
